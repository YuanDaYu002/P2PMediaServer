...
CURLcode result;
 ...
 // printf("<hle url_dowload_file> curl_handle->multi_easy->easyp->easy_conn->async.dns->addr->ai_addr->sa_family = %d\n",\
...
{
printf("<hle> into %s -> %s ->line(%d)\n",__FILE__,__func__,__LINE__);
printf("<hle debug> multi->easyp->easy_conn->async.dns->addr->ai_addr->sa_family = %d\n",\
			  multi->easyp->easy_conn->async.dns->addr->ai_addr->sa_family);  
bool done = FALSE;
  CURLMcode mcode = CURLM_OK;
  CURLcode result = CURLE_OK;
...
{
printf("<hle> into %s -> %s ->line(%d)\n",__FILE__,__func__,__LINE__);
printf("<hle debug> data->multi_easy->easyp->easy_conn->async.dns->addr->ai_addr->sa_family = %d\n",\
			  data->multi_easy->easyp->easy_conn->async.dns->addr->ai_addr->sa_family);
  ...
  if(data->multi_easy)
  {
	printf("<hle debug>%s %d into data->multi_easy\n",__FILE__,__LINE__);
...
printf("<hle debug>%s %d into else\n",__FILE__,__LINE__);
