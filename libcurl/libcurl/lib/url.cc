...
CURLcode Curl_open(struct Curl_easy **curl)
{
  ...
  memset(data,0,sizeof(struct Curl_easy));
   // printf("<hle Curl_open> curl_handle->multi_easy->easyp->easy_conn->async.dns->addr->ai_addr->sa_family = %d\n",\
      data->multi_easy->easyp->easy_conn->async.dns->addr->ai_addr->sa_family);

  data->magic = CURLEASY_MAGIC_NUMBER;

  result = Curl_resolver_init(&data->state.resolver);
   // printf("<hle Curl_resolver_init> curl_handle->multi_easy->easyp->easy_conn->async.dns->addr->ai_addr->sa_family = %d\n",\
      data->multi_easy->easyp->easy_conn->async.dns->addr->ai_addr->sa_family);
  if(result) 
  {
    ...
    else 
  {
   ...
   // printf("<hle Curl_init_userdefined> curl_handle->multi_easy->easyp->easy_conn->async.dns->addr->ai_addr->sa_family = %d\n",\
      data->multi_easy->easyp->easy_conn->async.dns->addr->ai_addr->sa_family);

      data->state.headersize = HEADERSIZE;
      Curl_convert_init(data);
     //   printf("<hle Curl_convert_init> curl_handle->multi_easy->easyp->easy_conn->async.dns->addr->ai_addr->sa_family = %d\n",\
      data->multi_easy->easyp->easy_conn->async.dns->addr->ai_addr->sa_family);
      Curl_initinfo(data);
       // printf("<hle Curl_initinfo> curl_handle->multi_easy->easyp->easy_conn->async.dns->addr->ai_addr->sa_family = %d\n",\
      data->multi_easy->easyp->easy_conn->async.dns->addr->ai_addr->sa_family);
      ...
      Curl_http2_init_state(&data->state);
        //printf("<hle Curl_http2_init_state> curl_handle->multi_easy->easyp->easy_conn->async.dns->addr->ai_addr->sa_family = %d\n",\
      data->multi_easy->easyp->easy_conn->async.dns->addr->ai_addr->sa_family);
    }
  }
