...
{
	char 	city[36];			//城市
	int  	diff_timezone; 		//跟UTC秒数的差距，有正负，范围[-10*3600,14*3600]
	float 	timezone;			//时区(有个别城市的时间使用时区不是整数)
	unsigned char num;		//该对象所处在数组中的下标 
	char 	res[3];
} city_time_zone ;

city_time_zone  tz_diff_table[142] =
{
	{"Honolulu",-36000,-10,0},
	{"Anchorage",-32400,-9,1},
	{"Vancouver",-28800,-8,2},
