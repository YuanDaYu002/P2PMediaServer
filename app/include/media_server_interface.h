...
typedef struct _med_ser_init_info_t
{
	...
	*/
	...
	/*
	 ...
	 @length: 帧长度 
	*/
	HLE_S32 (*get_one_YUV_frame_callback )(HLE_S32 channel,const void*frame_addr,HLE_S32 length);
	HLE_S32 (*get_one_H264_frame_callback)(HLE_S32 channel,const void*frame_addr,HLE_S32 length);
	HLE_S32 (*get_one_H265_frame_callback)(HLE_S32 channel,const void*frame_addr,HLE_S32 length);
	...
	/*
	 ...
	 @length: 帧长度 
	*/
	HLE_S32 (*get_one_encoded_frame_callback)(HLE_S32 channel,const void*frame_addr,HLE_S32 length);
 ...
 *	失败：media_server_error
 * ******************************************************************/
HLE_S32 media_server_start(void);
